...
<div class="row">
  <div class="col">
    <h1 class="text-center"><a href="/detailPem" class="text-decoration-none text-white">Laporan Data Pembayaran</a></h1>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">{{$loop->iteration}}</th>
                          ...
                          <td>{{$item->sudah_bayar}}/{{$item->berapa_kali}}</td>
