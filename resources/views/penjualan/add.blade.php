...
<div class="row">
  <div class="col">
    <h1 class="text-center text-dark">Tambah Data Penjualan</h1>
            <div class="card" style="background: linear-gradient(45deg, #5549E6,#B43CE6,#7E3CE5)">
                <div class="card-body">
                    <form action="/penjualan/add/proses" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          {{-- <div class=" mb-3 col">
                            ...
                            <div class="mb-3 mt-3 col">
                                <div class="mb-3 form-floating">
                                    <input type="text" name="nama_barang" class="form-control text-white" placeholder="Nama Barang" required>
                        ...
                        <div class="row">
                          <div class="mb-3 col">
                              <div class="mb-3 form-floating">
                                  <input type="text" name="kd_barang" class="form-control text-white" placeholder="Kode Barang">
                                  <label for="exampleInputEmail1" class="form-label" style="font-size: 15px">Kode Barang</label>
                              </div>
                          </div>
                          <div class="mb-3 form-floating col">
                            <div class="mb-3 form-floating">
                              <input type="number" name="harga" class="form-control text-white" placeholder="Harga Barang" id="inputA" required>
                        ...
                        <div class="row">
                          <div class="mb-3 form-floating col">
                            <div class="mb-3 form-floating">
                              <input type="number" name="jumlah" class="form-control text-white" placeholder="Jumlah Barang" id="inputB" required>
                              <label for="exampleInputEmail1" class="form-label" style="font-size: 15px">Jumlah Barang</label>
                            </div>
                          </div>
                          <div class="mb-3 col">
                            <div class="mb-3 form-floating">
                              <input type="date" name="tanggal_jual" class="form-control text-white" placeholder="Tanggal Punjualan" required>
                        ...
                        <input type="hidden" id="inputC" value="updateResult()" name="total">
