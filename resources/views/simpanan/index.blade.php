...
<div class="row">
  <div class="col">
    <h1 class="text-center text-dark">Data Simpanan</h1>
          <a href="/simpanan/add" class="btn btn-info">Tambah +</a>
        </div>
      </div>
                ...
                <table class="table mt-3" id="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" class="text-center" style="font-size: 12px">Aksi</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-dark text-center" style="font-size: 12px">KA-{{$item->anggota->id}}</td>
                          <td class="text-dark text-center" style="font-size: 12px">{{$item->anggota->nama}}</td>
                          <td class="text-dark text-center" style="font-size: 12px">{{formatRupiah($item->wajib)}}</td>
                          <td class="text-dark text-center" style="font-size: 12px">{{formatRupiah($item->simpanan)}}</td>
                          <td class="text-dark text-center" style="font-size: 12px">{{formatRupiah($item->sukarela)}}</td>
                          <td class="text-dark text-center" style="font-size: 12px">{{$item->tanggal}}</td>
                          <td class="text-dark text-center" style="font-size: 12px">{{$item->tanggal_saldo}}</td>
                          <td class=" text-center">
                            <div class="btn-group dropstart">
                              ...
                              <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/simpanan/add/{{$item->id}}">Tabungan</a></li>
                                <li><a href="/simpanan/edit/{{$item->id}}" class="dropdown-item">Edit</a></li>
