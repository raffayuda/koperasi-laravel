...
<div class="row">
  <div class="col">
    <h1 class="text-center text-dark">Data Pinjaman</h1>
          <a href="/pinjaman/add" class="btn btn-info">Tambah +</a>
        </div>
      </div>
                        ...
                        <td>
                          <div class="btn-group dropstart">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="/pinjaman/{{$item->id}}" class="dropdown-item">Edit</a></li>
    ...
    window.location = '/pinjaman/delete/' + pegawaiId
    swalWithBootstrapButtons.fire(
      'Deleted!',
